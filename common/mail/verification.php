                                        ...
                                        <tbody>
                                            <tr>
                                                <td valign="top" style="color:#565656;font-family:Helvetica;font-size:13px;line-height:150%;padding-top:25px;padding-right:30px;padding-bottom:5px;padding-left:30px;text-align:left;background:#ffffff">
                                                    ...
                                                    <?=Yii::t('app','verification invoice payment')?>
                                                    </h1>
                                                        Kepada Yth, Bapak/Ibu <?=Yii::$app->user->identity->first_name.' '.Yii::$app->user->identity->middle_name.' '.Yii::$app->user->identity->last_name?>
                                                        berikut adalah invoice tagihan pembayran untuk invoice <strong style="color:#444"><?=$data->invoice_no?></strong><br>
                                                    <br>
                                                        Konfirmasi Pembayaran sebesar <?=Yii::$app->formatter->asDecimal($data->confirm_total,2);?> dari rekening <?=$data->confirm_account;?> atas nama <?=$data->confirm_owner;?> akan kami verifikasi 1x24 Jam , lebih dari itu belum terima status lunas hub no.0857.2053.1358 Berikut adalah Details Invoice kami paparkan sebagai berikut: 
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td valign="top" style="color:#565656;font-family:Helvetica;font-size:13px;line-height:150%;padding-top:25px;padding-right:30px;padding-bottom:25px;padding-left:30px;text-align:left;background:#ffffff">
                                                    ...
                                                    Pesanan akan kami kirimkan apabila anda telah membayarkan sejumlah <?=Yii::$app->formatter->asDecimal($data->grand_total,2);?> ke Rekening <?=$data->bank_name?> :
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td valign="top" style="color:#565656;font-family:Helvetica;font-size:13px;line-height:150%;padding-top:5px;padding-right:30px;padding-bottom:25px;padding-left:30px;text-align:left;background:#ffffff">
                                                    Konfirmasikan melalui sistem kami di account anda pada halaman web atau konfirmasi pembayaran sms/wa ke 085-222-054-064 
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
