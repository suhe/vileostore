		...
		<!-- ./Title Email -->
			...
			<tr>
				...
				<div align="center" style="color:#808080;font-family:Arial;font-size:11px;line-height:150%;text-align:center">
				    <?=Yii::t('app/message','msg you now subscribe product of from vileo.co.id')?>
				</div>
                                        ...
                                        <tr style="padding:5px">
                                            ...
                                            <td  valign="top" bgcolor="#FFFFFF" style="background:#ffffff;border-collapse:collapse;padding:5px" colspan="8">
                                                ...
                                                <div style="padding-top:5px;margin:0 0 0 10px">
                                                    <p style="margin:0;padding:0;margin-bottom:20px;font-weight:normal;font-size:14px;line-height:1.6"><?=Yii::t('app/message','msg congrulation your email is sucessfully subscribe product')?></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
