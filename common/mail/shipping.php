                                        ...
                                        <tbody>
                                            <tr>
                                                <td valign="top" style="color:#565656;font-family:Helvetica;font-size:13px;line-height:150%;padding-top:25px;padding-right:30px;padding-bottom:5px;padding-left:30px;text-align:left;background:#ffffff">
                                                    ...
                                                    <?=Yii::t('app','shipping').' '.$data->courier_name?>
                                                    </h1>
                                                        Kepada Yth, Bapak/Ibu <?=$data->customer_name;?>
                                                        Pengiriman untuk Pemesanan dengan No Invoice :<strong style="color:#444"><?=$data->invoice_no?></strong>
                                                        telah kami kirimkan pada tanggal <?=$data->updated_date?>
                                                        <br>
                                                    <br>
                                                        Berikut adalah Details Pengiriman kami paparkan sebagai berikut: 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="padding:0 30px;color:#565656;font-family:Helvetica;font-size:13px;line-height:150%;text-align:left;background:#ffffff">
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse!important">
                                                        <tbody>
                                                            <tr>
                                                                <td valign="top" align="center" style="padding-top:20px;border:1px solid #ddd;width:900px;max-width:100%">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td valign="top" style="color:#565656;font-family:Helvetica;font-size:14px;line-height:150%;padding-top:0;padding-right:20px;padding-bottom:20px;padding-left:20px;text-align:center">
                                                                                    <h4 style="display:block;font-family:Helvetica;font-size:12px;font-weight:normal;line-height:100%;letter-spacing:normal;margin-top:0;margin-right:0;margin-bottom:3px;margin-left:0;color:#808080!important"><?=Yii::t('app','shipping')?></h4>
                                                                                    <strong style="color:#444;font-family:'courier new',courier,monospace;font-size:18px"><?=$data->courier_name?></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                ...
                                                                <td valign="top" align="center" style="padding-top:20px;border:1px solid #ddd;width:900px;max-width:100%">
                                                                    <table width="100%" cellspacing="0" cellpadding="20" border="0" style="border-collapse:collapse!important">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td valign="top" style="color:#565656;font-family:Helvetica;font-size:14px;line-height:150%;padding-top:0;padding-right:20px;padding-bottom:20px;padding-left:20px;text-align:center">
                                                                                    <h4 style="display:block;font-family:Helvetica;font-size:12px;font-weight:normal;line-height:100%;letter-spacing:normal;margin-top:0;margin-right:0;margin-bottom:3px;margin-left:0;color:#808080!important"><?=Yii::t('app','awb')?></h4>
                                                                                    <strong style="color:#444">
                                                                                    <span style="color:#ff1c2d"><?=$data->awb?></span> </strong>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
