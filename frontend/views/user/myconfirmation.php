...
<div class="contact-page">
	...
	<div class="col-md-12 contact-title" style="border-bottom: 1px solid #CCC">
	    <h4 style="margin-bottom:5px"><?=Yii::t('app','payment confirmation')?></h4>
	</div>
        
        <div class="col-md-12 contact-description" style="margin-top:15px">
            <p>
	...
	$form = \yii\bootstrap\ActiveForm::begin([
	    ...
	    <?=\yii\helpers\Html::submitButton('<i class="fa fa-pencil icon-on-right"></i> '.Yii::t('app','confirm'), ['class' => 'btn btn-primary btn-md pull-right','name' => 'post'])?>
