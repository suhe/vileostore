...
$this->params['breadcrumbs'] = [
    ['label' => Yii::t('app',$data->category_name),'url' => ['ticket/index']],
    ['label' => Yii::t('app','product'),'url' => ['ticket/new']]
];?>
...
<div class="row  wow fadeInUp">
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <div class="single-product-gallery-item" id="data<?=$image->id?>">
                <a data-lightbox="image-1" data-title="Gallery" href="<?=Yii::$app->params['baseUrl'] ?>assets/images/products/<?=$image->product_id?>/<?=$image->name?>">
                    <img class="img-responsive" alt="" src="<?=Yii::$app->params['baseUrl'] ?>assets/images/blank.gif" data-echo="<?=Yii::$app->params['baseUrl'] ?>assets/images/products/<?=$image->product_id?>/<?=$image->name?>" />
                </a>
        ...
        <div class="single-product-gallery-thumbs second-gallery-thumb gallery-thumbs">
            ...
            <div id="owl-single-product2-thumbnails">
                <?php foreach($images as $image){?>
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="<?=($image->id-1)?>" href="#data<?=$image->id?>">
                        <!--<img class="img-responsive" width="85" alt="" src="<?php // Yii::$app->params['baseUrl'] ?>assets/images/blank.gif" data-echo="<?php //Yii::$app->params['baseUrl'] ?>assets/images/products/<?php //$image->product_id?>/<?php //$image->name?>" />!-->
                   ...
                   <?php //\yii\imagine\Image::thumbnail('@image_product/images/products/1/c1.jpg', 120, 120)
                   //->save(Yii::getAlias('@image_product/thumb-test-image.jpg'), ['quality' => 50]);?>
                    </a>
                </div>
                <?php } ?>
							...
							<div class="product-info">
								...
								<div class="rating-reviews m-t-20">
									<div class="row">
										...
										<div class="col-sm-8">
											<div class="reviews">
												<a href="#" class="lnk">(<?=$data->review?> <?=Yii::t('app','reviews')?>)</a>
											</div>
										</div>
									</div><!-- /.row -->		
								</div><!-- /.rating-reviews -->
								...
								<div class="row outer-top-vs">
									<div class="cart col-md-12 clearfix animate-effect">
										<div class="action">
