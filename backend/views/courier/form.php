...
$this->params['breadcrumbs'] = [
    ...
    ['label' => Yii::t('app','form courier'),'url' => ['courier/add']],
];
        ...
        <div class="col-md-12">
            <div class="panel panel-transparent ">
                <div class="panel-heading">
                    <div class="panel-title"><?=Yii::t('app','form courier')?></div>
                ...
                <div class="panel-body">
                    ...
                    <?=$form->field($model, 'icon')->widget(FileInput::classname(), [
                        ...
                        'pluginOptions' => [
                            'initialPreview' => [
                                isset($model->id)?Html::img(str_replace('backend/web/','',Yii::$app->request->baseUrl.'/assets/images/brands/'.$model->id.'/'.$model->icon), ['class'=>'file-preview-image img-responsive']):'',
                            ],
                            'showPreview' => true,
                            'showCaption' => true,
                            'showRemove' => true,
