...
$this->params['breadcrumbs'] = [
    ...
    ['label' => Yii::t('app','form area'),'url' => ['area/add_area']],
];
$this->title = Yii::t('app','form area');
        ...
        <div class="col-md-12">
            <div class="panel panel-transparent ">
                <div class="panel-heading">
                    <div class="panel-title"><?=Yii::t('app','form area')?></div>
                ...
                <div class="panel-body">
                    ...
                    <?=$form->field($model,'city_id')->dropDownList(\common\models\City::dropdownWithProvinceList(Yii::t('app','select city')),['class'=>'cs-select cs-skin-slide','data-init-plugin'=>'cs-select'])?>
