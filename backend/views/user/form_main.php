            ...
            <div class="panel panel-transparent ">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm hidden-print">
                        <li <?=Yii::$app->controller->getRoute()=='user/edit'?'class="active"':''?>><a href="<?=Url::to(['user/edit','id'=>$page_id])?>"><span><?=Yii::t('app','information')?></span></a></li>
                        <li <?=Yii::$app->controller->getRoute()=='user/address'?'class="active"':''?>><a href="<?=Url::to(['user/address','id'=>$page_id])?>"><span><?=Yii::t('app','address')?></span></a></li>
                        <li <?=Yii::$app->controller->getRoute()=='user/transaction'?'class="active"':''?>><a href="<?=Url::to(['user/transaction','id'=>$page_id])?>"><span><?=Yii::t('app','transactions')?></span></a></li>
                    </ul>
